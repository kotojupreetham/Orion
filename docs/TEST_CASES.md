...
**Workspace Entry** — What the user types:
```
"Plastic waste is a complex adaptive system. I'm thinking about this in layers:

LAYER 1 (Causal): Why does plastic accumulate in streets?
- Citizens lack convenient collection points
- Waste workers have no incentive to sort
- Recyclers can't process mixed plastic economically
These aren't separate problems—they're interconnected.

LAYER 2 (Systems): What's the leverage point?
The answer: Economic alignment. Create a price signal that incentivizes sorting at source.

LAYER 3 (Institutional): How do I scale this insight without building bureaucracy?
Partnership model with existing waste management organizations.

My research-backed strategy:
1. Causal map creation (₹3k): Detailed stakeholder system map
2. Incentive sensitivity analysis (₹8k): Model different price points, find 
   equilibrium where model self-sustains
3. Pilot in 1 neighborhood (₹25k): Test the price equilibrium in practice
4. Policy brief (₹9k): Write recommendations for municipal adoption

Success = Understanding the system deeply enough that I can advise cities on policy, 
not just run programs."
```
**Workspace Entry** — What the grandmaster types:
```
"Plastic waste is an institutional failure masquerading as a civic problem.

The real issue: Municipal waste systems were designed for centralized collection 
in developed cities. But in mixed-density urban settings with informal waste workers, 
that model doesn't apply.

My research hypothesis:
Waste workers are already doing 60% of collection work informally, but they're 
invisible in policy. If I formalize their role with economic incentives tied to 
quality sorting, I can:**
1. Reduce municipal burden
2. Increase waste worker income (dignity)
3. Improve recycler feedstock quality
4. Create a replicable model for 50+ cities

The ₹50k investment:
- Institutional analysis (₹5k): Map municipal policies, waste worker unions, 
  recycler industry standards
- Causal research (₹12k): RCT-style pilot testing 3 price points with 100 waste 
  workers over 8 weeks
- Policy modeling (₹20k): Build economic models showing municipal cost savings 
  vs. formalization
- Advocacy document (₹10k): Write blueprint for municipal adoption + implementation guidance

The goal isn't a program I run—it's a system redesign I influence.

If successful, I approach 10 mayors, 8 take action. That's 1M+ people in 
formalized waste collection systems. That's scaling through institutional change, 
not direct operation."
```

**Workspace UI for Grandmaster:**
- 🏛️ Institutional analysis: Policy gaps, implementation barriers, actor incentives
- 📊 Rigorous causal research: RCT-style studies, effect sizes, confidence bounds
- 🗺️ Scalability model: Municipal adoption playbook, ROI for cities, franchise architecture
- 🎯 Right panel: Policy leverage points, stakeholder alignment, 10-year impact projection
**Workspace UI for Pro Catalyst:**
- 🔍 Causal systems map: Stakeholder interactions, feedback loops, leverage points
- 📊 Sensitivity analysis: Price elasticity, market equilibrium models
- 🎯 Theory of change: Assumptions, intervention points, scale pathway
- 📈 Right panel: Causal insights, policy implications, scaling readiness Program-theory model: Assumptions, indicators, validation tests
